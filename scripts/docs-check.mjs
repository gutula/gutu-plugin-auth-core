...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/auth-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-auth-core:");
...
console.log("Documentation check passed for gutu-plugin-auth-core.");
